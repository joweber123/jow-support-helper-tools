...
function pluginAreaAddHTML(){
    ...
    chatToolBar.insertAdjacentHTML('afterend', `<div id="chat-plugin-container"><div id="chat-plugin-1" class="chat-plugin-element" ></div><div id="chat-plugin-2" class="chat-plugin-element" ></div><div id="chat-plugin-3" class="chat-plugin-element" ></div><div id="chat-plugin-4" class="chat-plugin-element" ></div><div id="chat-plugin-5" class="chat-plugin-element"></div></div>`);
...
function pluginAreaRemoveClick(e){
    if ( e.target.id === 'chat-plugin-container' || e.target.id === 'chat-plugin-menu-item' ) {
        return;
    }
